...
- Documentazione: ogni processo deve essere supportato da una documentazione, come ad esempio la sua durata e la data di conclusione prevista.
- Analisi dei rischi: ogni processo deve essere analizzato a monte per individuarne eventuali rischi e di conseguenza pianificare le possibili strategie per mitigarli.
...
- Sostiuire un mebro con un altro.

==== Possibili fattori che portano al cambiamento
Esistono diversi fattori che possono indurre ad un cambiamento. Lo standard citato li rissume in:
- Fattori esterni: come la variazione dei prezzi, il cambio di tecnologia, l'introduzione di nuove leggi, il cambiamento delle richieste del consumatore e l'incremento della competività a livello di mercato;
- Fattori interiL: come lintroduzione di nuovi prodotti o servizi, l'immediata riduzione dei costi, l'introduzione di nuovi modelli di gestione e sviluppo del progetto.

==== Esempi di condizioni per un cambiamento efficace
Il successo del cambiamento dipende da come esso si interfaccia con le attitudini e le credendenze di ogni membro del gruppo di progetto. Comunemente, maggiore è il coinvolgimento delle persone a tutti i livelli, più facile sarà il cambiamento. Per ottenere questo è necessario: \

1. Assicurarsi che gli obiettivi siano compresi da tutti: comunicare chiaramente i motivi del cambiamento e i suoi benefici per l'organizzazione e per i singoli individui, fornire informazioni complete e accessibili a tutti i livelli e promuovere un dialogo aperto rispondendo alle domande e alle preoccupazioni del personale.
2. Analizzare il team per capire dove intensificare gli interventi: identificare i diversi gruppi di persone all'interno dell'organizzazione e le loro differenti posizioni rispetto al cambiamento, valutare il livello di resistenza al cambiamento e le sue cause, individuare i leader informali e gli opinionisti all'interno del team.
3. Costruire il cambiamento senza stravolgere le pratiche comuni: rispettare la cultura e le tradizioni dell'organizzazione, introdurre gradualmente i nuovi processi e le nuove procedure.
4. Assicurarsi che l'appoggio del responsabile sia forte: il responsabile deve essere il primo sostenitore del cambiamento e dare l'esempio, deve comunicare il suo impegno al cambiamento e coinvolgere attivamente il team, deve riconoscere e premiare i comportamenti che supportano il cambiamento.
5. Curare la comunicazione: comunicare frequentemente e in modo trasparente con tutti i livelli dell'organizzazione, utilizzare diversi canali di comunicazione per raggiungere tutti i destinatari, promuovere un feedback aperto e bidirezionale.
6. Coinvolgere il proponente ed i committenti: il proponente del cambiamento deve essere coinvolto attivamente nella sua implementazione, i committenti del cambiamento devono fornire le risorse necessarie e il supporto al team, devono essere riconosciuti i contributi del proponente e dei committenti al successo del cambiamento.
...
=== Metriche e strumenti per il controllo della qualità
