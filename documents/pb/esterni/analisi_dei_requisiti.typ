...
requirements("#bbfabe", ( 
  ...
  [Capitolato],
  [R-005-Q-2],
  [Occorre effettuare una serie di stress test (test di carico) per alcuni casi d'uso implementati e riportare con un apposito documento i benchmark del sistema in ogni situazione: normale, di carico e di sovraccarico. Questi andranno specificati all'interno del `Manuale Utente` in una sezione dedicata.],
  [Capitolato],
  [R-006-Q-1],
