...
#show: project.with(
  ...
  changelog: ( 
    "0.1.2", "2023-12-19", p.bulychov, p.fabbian, "Terminata la stesura della sezione 'Sviluppo'",
    "0.1.1", "2023-12-17", p.bulychov, p.furno, "Migliorate le sezioni 'Verifica' e 'Validazione'",
